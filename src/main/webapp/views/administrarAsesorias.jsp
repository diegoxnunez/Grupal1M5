...
<title>APR - Admin Asesorias</title>
						...
						$('a[data-target="#deleteModal"]')
								.click(
										function() {
											...
											var deleteUrl = "${pageContext.request.contextPath}/administrarasesorias?a=delete&id="
													+ deleteId;
...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Listado de Asesorias</h1>
					<p class="mb-4">Listado de todas las Asesorias del sistema</p>

					<!-- DataTales Example -->
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Asesorias</h6>
						</div>
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered dataTable" id="dataTable"
									...
									<tbody>
										...
										<c:forEach var="asesoria" items="${Asesoria}">

											<tr>
												<td><c:out value="${Asesoria.getId()}"></c:out></td>
												<td><c:out value="${Asesoria.getNombre()}"></c:out></td>
												<td><c:out value="${Asesoria.getDetalle()}"></c:out></td>
												<td><a
													href="${pageContext.request.contextPath}/administrarasesoria?a=read&id=${asesoria.getId()}"><i
														class="fa-solid fa-book-open"></i></a> <a
													href="${pageContext.request.contextPath}/administrarasesoria?a=edit&id=${asesoria.getId()}"><i
														class="fa-solid fa-pen-to-square"></i></a> <a href="#"
													data-toggle="modal" data-id="${asesoria.getId()}"
	...
	<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="deleteModal">Eliminar asesoria</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
