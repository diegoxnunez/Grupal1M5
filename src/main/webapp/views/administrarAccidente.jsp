						...
						$('a[data-target="#deleteModal"]')
								.click(
										function() {
											...
											var deleteUrl = "${pageContext.request.contextPath}/administraraccidente?a=delete&id="
													+ deleteId;
...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Listado de accidentes</h1>
					<p class="mb-4">Listado de todos los accidentes</p>

					<!-- DataTales Example -->
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Accidentes</h6>
						</div>
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered dataTable" id="dataTable"
									...
									<tbody>
										...
										<c:forEach var="accidente" items="${accidente}">
											...
											<tr>
												...
												<td><a
													...
													href="${pageContext.request.contextPath}/administraraccidente?a=edit&id=${accidente.getId()}"><i
														class="fa-solid fa-pen-to-square"></i></a> <a href="#"
													data-toggle="modal" data-id="${accidente.getId()}"
	...
	<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="deleteModal">Eliminar accidente</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
				...
				|
				<div class="modal-body">Seguro quieres borrar este
					registro?</div>
				<div class="modal-footer">
					<button class="btn btn-secondary" type="button"
						data-dismiss="modal">Cancelar</button>
					<a class="btn btn-primary"
						href="${pageContext.request.contextPath}/administraraccidente?a=delete&id="
